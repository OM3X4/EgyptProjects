    ...
    <>
        <div className={`fixed z-50 w-screen ${!isAtTop ? "bg-gray-900" : ""} transition-all duration-500  h-28 flex items-center justify-end px-32 gap-30`}>
            <div className='flex gap-8 items-center flex-row-reverse'>
                <Link><h1 className='font-medium text-white text-xl hover:text-[#c79801] cursor-pointer transition-all'>الرئيسية</h1></Link>
                <Link><h1 className='font-medium text-white text-xl hover:text-[#c79801] cursor-pointer transition-all'>المدن</h1></Link>
                <Link><h1 className='font-medium text-white text-xl hover:text-[#c79801] cursor-pointer transition-all'>البنية التحتية</h1></Link>
